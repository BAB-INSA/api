    ...
    "paths": {
        ...
        "/team-matches/{id}/confirm": {
            "patch": {
                ...
                "description": "Confirm a pending team match",
                "produces": [
                    "application/json"
                ],
                "tags": [
        ...
        "/teams/get-or-create": {
            "post": {
                ...
                "description": "Find existing team or create new one with two players",
                "consumes": [
                    "application/json"
                ],
                "produces": [
